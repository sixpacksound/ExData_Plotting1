...
## Setting destination file and sheet for four plots

png("plot4.png")
par("mfrow" = c(2,2))

## Sending each plot to sheet

plot(df$FullDate, df$Global_active_power, type="l",
     ylab = "Global Active Power", xlab="")

plot(df$FullDate, df$Voltage, type="l", ylab = "Voltage", xlab = "datetime")
...
plot(df$FullDate, df$Global_reactive_power, type="l", ylab = "Global_reactive_power",
     xlab = "datetime")
